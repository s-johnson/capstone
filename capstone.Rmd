...
svyby(~suicidal, ~saab, USTS.design, svymean, na.rm = T)
svyby(~suicidal, ~intersex, USTS.design, svymean, na.rm = T)
```
...
svyby(~disc.trans, ~intersex, USTS.design, svymean, na.rm = T)
```
...
glm.int <- svyglm(suicidal ~ disc.trans +
                    affirm.total + 
                    disc.non.trans + 
                    age + 
                    race + 
...
glm.ixn <- svyglm(suicidal ~ disc.trans*affirm.total +
                    disc.non.trans + 
                    age + 
                    race + 
                    saab + 
...
#                     nest = FALSE,
#                     data = data.all)
vars <- c("suicidal", "disc.trans", "disc.non.trans", "affirm.total", "affirm.provider", "affirm.family", "affirm.id.name", "affirm.id.gender", "affirm.hormone", "affirm.med.surg", "age", "race",  "education", "poverty", "citizenship", "religious", "military", "disability", "saab", "passing", "outness", "orientation")
fvars <- c("suicidal",  "affirm.family", "affirm.provider", "affirm.id.name", "affirm.id.gender", "affirm.hormone", "affirm.med.surg", "race", "education", "poverty", "citizenship", "religious", "military",  "disability", "saab", "passing", "outness", "orientation")
```
